-- Drop and recreate the advance_approval_chain function to fix ambiguous column references
DROP FUNCTION IF EXISTS public.advance_approval_chain(uuid,uuid,text,text);
