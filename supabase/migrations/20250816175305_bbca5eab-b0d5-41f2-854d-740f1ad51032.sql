...
BEGIN
  ...
  ELSE
    ...
    -- Step 1: Treasurer (but status stays 'submitted' since no specific treasurer status)
    -- Step 2: Head of Department
    -- Step 3: Finance Elder  
    -- Step 4: General Secretary
    -- Step 5: Pastor
    ...
    ELSE
      ...
      ELSE
        ...
        new_status := CASE next_step
          WHEN 1 THEN 'submitted'::money_request_status
