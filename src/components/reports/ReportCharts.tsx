...
export function ReportCharts({ data, filters }: ReportChartsProps) {
  ...
  const fundTypeData = data.reduce((acc, contribution) => {
    ...
    if (!acc[fundTypeName]) {
      acc[fundTypeName] = { name: fundTypeName, value: 0 };
    }
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-lg font-semibold">Fund Type Distribution</CardTitle>
        </CardHeader>
        <CardContent>
      ...
      <Card className="lg:col-span-2">
        <CardHeader>
          <CardTitle className="text-lg font-semibold">Contributions by Fund Type</CardTitle>
        </CardHeader>
        <CardContent>
          <ChartContainer config={chartConfig} className="h-64">
